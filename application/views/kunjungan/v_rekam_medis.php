                ...
                <div class="col-md-6">
                    <div class="card border-danger">
                        <div class="card-header bg-danger text-white">
                            Catatan (Rekam Medis)
                            <a href="<?= base_url('kunjungan');?>" class="btn
                             btn-warning btn-sm float-right">Kembali</a>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card border-success mt-4">
                        ...
                        <div class="card-body">
                            <form method="podt" action="<?= base_url('kunjungan/insert_resep'); ?>">
                                <input type="hidden" name="id" value="<?= $d['id_berobat']; ?>">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <select name="obat" id="" class="form-control">
                                                <?php foreach($obat as $r){ ?> 
                                                    <option value="<?= $r['id_obat']; ?>"><?= $r['nama_obat'];?>
                                                    </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                        ...
                        <table class="table table striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $r['nama_obat']; ?></td>
                                    <td>
                                        <a href="<?= base_url().'kunjungan/hapus_resep/'.$r['id_resep']
                                        .'/'.$r['id_berobat']; ?>" class="text-danger">x</a>
                                    </td>
                                </tr>
                                <?php $no++; } ?>
                            </tbody>
